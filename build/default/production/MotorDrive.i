...
static UB spkReqVrsCheckWait;

static UB spkStopStatus;
static UB excitatingStatusOn;
...
void SetDataTRISxWork_SPK_SHORT(void)
{
    ...
    if (0 == spkStopStatus) {
        if (0 == spkReqVrsCheckWait) {
            spkReqVrsCheckBit |= (0x01 | 0x02);
        } else {
            spkReqVrsCheckWait = 0;
        }
    }
}
